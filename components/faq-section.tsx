...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "خطة واحدة مبسطة: اشتراك سنوي بـ 94 دينارًا تونسيًا برسائل غير محدودة. بالإضافة إلى خطة مؤسسية مخصصة (نسخة خاصة/Instance) لمن يحتاج حلاً كاملاً لمؤسسته — تواصل معنا للتفاصيل والأسعار.",
  },
  {
  ...
  {
    question: "هل الأسعار المعلنة تشمل الأداء (TVA)؟",
    answer:
      "نعم، أسعار الباقات المعلنة بالدينار التونسي تشمل الأداء على القيمة المضافة (TVA) المعمول به قانونيًا في تونس. أما أي عملية شراء إضافية خارج الباقة المشترَك فيها (مثل رسائل إضافية أو خدمات تكميلية) فتخضع للأداء بشكل منفصل ويُضاف إلى السعر المعلن وقت الشراء.",
  },
  {
